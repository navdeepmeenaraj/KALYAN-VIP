package kalyanksd.online.satta.e.ui.main.fragments.bids
...
import kalyanksd.online.satta.e.databinding.FragmentTpBinding
...
import kalyanksd.online.satta.e.basic_utils.BasicUtils.getMinMaxBetMessage
...
import kalyanksd.online.satta.e.basic_utils.BasicUtils.showInfoSnackBar
...
@AndroidEntryPoint
class TriplePanelFragment : Fragment() {

    private val secondViewModel: SecondViewModel by viewModels()

    private lateinit var binding: FragmentTpBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTpBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun verifyBidDigits(inputDigit: String): Boolean {
        val digits = BasicUtils.tpDigits()
        return digits.contains(inputDigit)
    }
